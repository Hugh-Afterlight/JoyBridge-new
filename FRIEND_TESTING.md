...
1. Download `JoyBridge-new-v0.10.0-local-test.zip`.
2. Unzip it.
3. Move `JoyBridge-new.app` to the Applications folder.
4. Open `JoyBridge-new.app`.
...
1. 下载 `JoyBridge-new-v0.10.0-local-test.zip`。
2. 解压。
3. 把 `JoyBridge-new.app` 移到“应用程序”文件夹。
4. 打开 `JoyBridge-new.app`。
